...
#seting output 
set nm [open TcpVegas-RED.nam w]
$ns namtrace-all $nm
set nt [open TcpVegas-RED.tr w]
$ns trace-all $nt
...
#Node penerima 
$ns duplex-link $n3 $n4 5Mb 10ms RED
$ns duplex-link $n3 $n5 5Mb 10ms RED

#Setting panjang antrian (parameter buffer yang akan di ubah2 
